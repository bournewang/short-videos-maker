  ...
  return (
    <main className={`studio-shell ${audioData && !episodesOpen ? "has-narration-bar" : ""}`}>
      ...
      <section className="workspace">
        {stage !== "livestream" && <header className="topbar">
