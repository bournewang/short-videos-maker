...
import { DEFAULT_SUBTITLE_STYLE, SUBTITLE_FONTS, SUBTITLE_PRESETS, normalizeSubtitleStyle, subtitleCssBackground } from "./lib/subtitle-style";
...
function ExportPanel({ title, productionMode, shots, approved, duration, audioName, bgm, build, previewUrl, downloadUrl, videoBuilds, downloadResolution, setDownloadResolution, screenRatio, busy, buildProgress }: any) {
  const longScenes = productionMode === "long-scenes";
